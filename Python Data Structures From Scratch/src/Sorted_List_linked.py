...
class Sorted_List:
    ...
    def insert(self, value):
        ...
        if self._front is None:
            ...
            temp = self._front
            self._front = _SL_Node(value, temp)
    ...
    def _insert(self, value):
        """
        -------------------------------------------------------
        Private method (to avoid high level calls): 
        Inserts value at the proper place in the sorted list.
        Must be a stable insertion, i.e. consecutive insertions
        of the same value must keep their order preserved.
        Use: sl.insert(value)
    ...
    def _linear_search(self, key):
        ...
        Use: i = self._linear_search(key) #previous, current, index = self._linear_search(key)
        -------------------------------------------------------
        Parameters:
        ...
        while source1_node is not None:
            ...
            if current is not None:
                ...
                if current is None:
                    ...
                    self._insert(source1_node._value)
