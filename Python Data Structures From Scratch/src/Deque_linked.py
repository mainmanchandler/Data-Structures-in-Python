...
class Deque:
    ...
    def insert_front(self, value):
        ...
        if self._front is not None: 
            new_front = _Deque_Node(value, None, self._front)
            self._front = new_front
                    
        else:
            temp = _Deque_Node(value, None, None)
            self._front = temp
            self._rear = temp
    ...
    def insert_rear(self, value):
        ...
        if self._rear is not None: 
            new_rear = _Deque_Node(value, self._rear, None)
    ...
    def _swap(self, l, r):
        ...
        if l is not r:
            ...
            #swapping the left node ends with the right node
            ...
            #swapping the right node ends with the left node
            ...
            #swapping the addresses of the right and left node ends
            temp = l._next
            l._next = r._next
            r._next = temp
